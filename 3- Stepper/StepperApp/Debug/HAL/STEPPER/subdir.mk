...
HAL/STEPPER/%.o HAL/STEPPER/%.su: ../HAL/STEPPER/%.c HAL/STEPPER/subdir.mk
...
clean-HAL-2f-STEPPER:
	-$(RM) ./HAL/STEPPER/STEPPER_Program.d ./HAL/STEPPER/STEPPER_Program.o ./HAL/STEPPER/STEPPER_Program.su
